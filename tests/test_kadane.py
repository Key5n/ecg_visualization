...
def test_returns_max_sum_and_subarray_for_mixed_values() -> None:
...
def test_returns_single_largest_value_for_all_negative_input() -> None:
...
def test_returns_only_value_for_single_element_input() -> None:
    result = kadane([4.0])
