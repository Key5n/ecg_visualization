...
from ecg_visualization.scripts.ltafdb_concat.utils import (
...
RR_HISTOGRAM_MEDIAN_BAND_SEC = 0.1
SEGMENT_LABELS = {
    "sinus_train": "train",
    "pre_af": "pre-af",
    "af": "af",
...
def ltafdb_concat_visualize() -> None:
...
def _render_rr_interval_histogram_page(
    ...
    if rr_intervals_sec.size > 0:
        ...
        sinus_lower = median_rr_interval - RR_HISTOGRAM_MEDIAN_BAND_SEC
        sinus_upper = median_rr_interval + RR_HISTOGRAM_MEDIAN_BAND_SEC
        ax.axvspan(
            sinus_lower,
            sinus_upper,
            color="tab:green",
...
def _highlight_concat_segments(
    ...
    *,
    ...
    for name, window in (
        ...
        ("pre_af", concat.segments_info.pre_af),
        ("af", concat.segments_info.af),
